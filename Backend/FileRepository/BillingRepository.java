...
public class BillingRepository {
    private final String FILE_PATH = "./data/bills.txt"; // Matches your folder structure
    ...
    public void deleteById(String billId) {
        ...
        // Use OOP logic to filter out the bill with the matching ID
        List<Billing> updatedBills = allBills.stream()
                .filter(b -> !b.getBillId().equals(billId))
                .toList();

        // Overwrite the bills.txt with the new list
